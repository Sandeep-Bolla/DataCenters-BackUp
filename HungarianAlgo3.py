...
#_fileLocation = None
#_fileName = None
_MTX=[[10000,3,2,3,5,5],[3,10000,3,5,5,4],[2,3,10000,3,4,4],[3,5,3,10000,3,4],[5,5,4,3,10000,3],[5,4,4,4,3,10000]]
_n=6
...
class HungarianAssignment:
    ...
    def reduceMatrix(self):
        ...
        for i in range(self.row):
            ...
            self.M[i] = [x - minElem for x in self.M[i]]
...
def readInput():
    ...
    try:
        ...
        _n = n
        M = [[-1 for a in range(_n)]
             for b in range(_n)]  # denotes the matrix
...
def main(fileHandle=None):
    global _backup, finalResult, backup_dc_id
